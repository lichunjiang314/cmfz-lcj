...
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/admin/login" method="post" data-options="novalidate:true">
				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  name="name" class="easyui-textbox" value="请输入用户名" maxlength="20" data-options="iconCls:'icon-man'"/>
							</td>
					  </tr>
					  <tr>
							<th>
							...
							<td>
								<input type="password" name="password" class="easyui-passwordbox" value="xxx" maxlength="20" autocomplete="off"/>
							</td>
					  </tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/validation"/>
							</td>
						</tr>					
					<tr>
						<td>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<a id="btnCon" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">登录</a>
						</td>
					</tr>
				</tbody></table>
