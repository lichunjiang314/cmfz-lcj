        ...
        $(function () {
            ...
            $("#gg").datagrid({
                ...
                columns:[[
                    ...
                    {title:'上师性别',field:'sex',width:120,},
                    {title:'操作',field:'options',width:200,
                        formatter:function(value,row,index){
                            return "<a href='javascript:;' class='options' onclick=\"delRow('"+row.id+"')\" data-options=\"iconCls:'icon-pencil',plain:true\">删除</a>&nbsp;&nbsp;" +
                                "<a href='javascript:;' class='options' onclick=\"openEditGuruDialog('"+row.id+"')\" data-options=\"iconCls:'icon-edit',plain:true\">修改</a>";
                        }
                    }
                ]],
                ...
                detailFormatter: function(rowIndex, rowData){
                    return '<table><tr>' +
                        '<td rowspan=2 style="border:0"><img src="${pageContext.request.contextPath}' + rowData.headpic + '" style="height:80px;"></td>' +
                        '<td style="border:0">' +
...
<div id="tb">
    ...
    <a href="#" class="easyui-linkbutton" onclick="delGuruRows();" data-options="iconCls:'icon-pencil',plain:true">批量删除</a>
</div>

<%--保存用户对话框--%>
<div id="saveGuruDialog" data-options="href:'${pageContext.request.contextPath}/back/guru/save.jsp',draggable:false,iconCls:'icon-save',width:600,height:400,title:'保存用户信息'">
...
<%--更新用户对话框--%>
<div id="editGuruDialog" data-options="draggable:false,iconCls:'icon-edit',width:600,height:400,title:'修改用户信息'">
