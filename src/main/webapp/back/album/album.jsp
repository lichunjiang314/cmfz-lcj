...
<script type="text/javascript">
    var toolbar = [{
        ...
        handler: function () {
           ...
           if(row == null ){
               ...
               if(row.size == null){  //选中的是专辑
                   ...
                   $("#coverImg").prop("src","${pageContext.request.contextPath}"+row.img);
        ...
        handler: function () {
            var row = $("#album").treegrid("getSelected");
            location.href = "${pageContext.request.contextPath}/chapter/download?fileName=" + row.href + "&openStyle=" + row.title;
        }
    }]
    ...
    $(function () {
        $("#album").treegrid({
            ...
            columns: [[
                ...
                {field:'href',title:'下载路径',width:50,align:'center'},
...
<div id="album_dialog" class="easyui-dialog" title="专辑详情" style="width:600px;height:750px;"
    ...
    <form id="album_ff" method="post">
        ...
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <input id="score" name="star" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%">
        </div>

        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <label for="author">专辑作者:</label>
            <input id="author" name="autho" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%">
        </div>
        ...
        <div style="margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <img id="coverImg" src=""  style="width:30%;height: 30%">
        </div>
...
<div id="chapter_dialog" class="easyui-dialog" title="添加章节" style="width:400px;height:500px;"
    ...
    <form id="chapter_ff" method="post" enctype="multipart/form-data">
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <input name="name"  required="true" class="easyui-textbox" data-options="iconCls:'icon-man',prompt:'章节名称'" style="width:100%;height: 100%">
        </div>

        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
             <input type="text" name="date"  class="easyui-datebox" data-options="iconCls:'icon-man',prompt:'上传日期'" style="width:100%;height: 100%">
        </div>

        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <input name="aid"  required="true" class="easyui-textbox" data-options="iconCls:'icon-man',prompt:'所属专辑'" style="width:100%;height: 100%">
        </div>
...
<div id="album_paly" class="easyui-dialog" title="播放音频" style="width:400px;height:200px;"
    ...
    <div style="margin-top: 40px">
        歌曲名称：<span id="musicName" style="color:#F00"></span>
    </div>
...
<div id="album_addg" class="easyui-dialog" title="添加专辑" style="width:400px;height:650px;"
    ...
    <form id="album_add" method="post" enctype="multipart/form-data">
        ...
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <input name="autho" required="true" class="easyui-textbox" data-options="iconCls:'icon-man',prompt:'作者'" style="width:100%;height: 100%">
        </div>
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
        ...
        <div style="height: 40px;margin-bottom: 30px;margin-top: 10px;padding-left: 20%;padding-right: 20%">
            <input name="bannerFileName" required="true"  class="easyui-filebox"  style="width:100%;height: 100%">
        </div>
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <input type="text" name="date"  class="easyui-datebox" data-options="iconCls:'icon-man',prompt:'上传日期'" style="width:100%;height: 100%">
        </div>
